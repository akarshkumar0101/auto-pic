...
class ImageCPPN(nn.Module):
    def __init__(self, n_hidden=24, n_layers=8, n_channels=3, activation=composite_activation, give_radius=False):
        super().__init__()
        
        self.give_radius = give_radius
